                ...
                {warehouseCards.map((item) => {
                  ...
                  return (
                    <div
                      ...
                      className="flex items-center justify-between rounded-[18px] border cursor-pointer border-slate-300 bg-white px-6 py-6
                       hover:shadow-lg transition"
                    >
                      <div className="flex items-center gap-4">
                        <div className="md:h-10 md:w-10 h-8 w-8 rounded-full border border-slate-200 flex items-center justify-center text-slate-700">
                          <Icon size={18} />
                        </div>
